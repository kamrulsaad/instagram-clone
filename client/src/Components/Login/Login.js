    ...
    return (
        <div className="relative">
            ...
            <div className="relative min-h-screen bg-gray-900 bg-opacity-100">
                <div className="px-4 py-16 mx-auto min-h-screen flex items-center justify-center sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                                Join now to get a real life social media experience on <span className='grand-hotel gradient-bg'>Instagram</span> <br /> Its never too late to get connected with the world
                            </h2>
